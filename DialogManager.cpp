...
void DialogManager::displayInputDialog(const Account& player,
...
void DialogManager::displayMessageDialog(const Account& player,
	const std::string& caption, const std::string& info,
...
void DialogManager::displayListDialog(const Account& player,
